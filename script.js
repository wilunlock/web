...
let backgroundImages = [
  "https://i.postimg.cc/zBHkTjWP/amt.jpg",
  "https://i.postimg.cc/rFk9t5pQ/chimera.jpg",
  "https://i.postimg.cc/s2qYfh8P/iremoval.jpg",
  "https://i.postimg.cc/yxz0cz7k/pandorabox.jpg",
  "https://i.postimg.cc/Hn4XtPL3/samsung.jpg",
]
...
function loadBackgroundImages() {
  ...
  if (savedImages) {
    try {
      ...
      console.log("Error parsing saved images, using defaults")
    }
  }
...
function updateBackgroundImages() {
  ...
  backgroundImages.forEach((image, index) => {
    ...
    // Crear elemento img y configurarlo
