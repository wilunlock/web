...
let backgroundImages = [
  "https://i.postimg.cc/JzqssLBT/logo.jpg",
  "https://i.postimg.cc/L89H0Qxw/reseller.jpg"
]
...
let notices = [
  {
    ...
    content:
      'Estimado Cliente, Todos Nuestros Servicios Funcionan 24/7  Por Favor Antes de Realizar el Pedido Debe Contar el Tiempo Máximo de Servicio También Nuestro Método de Pago Funciona Manualmente, Así que Después de Completar el Pago Por Favor Contáctenos en Support Ticket O WhatsApp/Telegram',
    active: true,
  },
  {
    id: 2,
...
let tools = [
  { id: 1, name: "OCTOPUS", image: "https://i.postimg.cc/ZKfg4fT1/images.jpg", gradient: "gradient-blue" },
  { id: 2, name: "Z3X", image: "https://i.postimg.cc/q79H01Gk/z3x.jpg", gradient: "gradient-purple" },
  { id: 3, name: "UMT", image: null, gradient: "gradient-green" },
  { id: 4, name: "LOCKR", image: null, gradient: "gradient-red" },
  { id: 5, name: "DFTPRO TOOL", image: "https://i.postimg.cc/76Msc9st/dft-pro.jpg", gradient: "gradient-orange" },
  { id: 6, name: "UNLOCKTOOL", image: "https://i.postimg.cc/hGsVRmrt/uinlocktool.jpg", gradient: "gradient-indigo" },
  { id: 7, name: "MDMFIXTOOL", image: "https://i.postimg.cc/8z0qBZ9h/mdmfixtool.webp", gradient: "gradient-blue-dark" },
  { id: 8, name: "PANDORA", image: "https://i.postimg.cc/q79H01Gk/z3x.jpg", gradient: "gradient-red-dark" },
]
...
function addFavicon() {
  ...
  favicon.href = "https://i.postimg.cc/JzqssLBT/logo.jpg"
  document.head.appendChild(favicon)

  // Also add apple touch icon
  const appleFavicon = document.createElement("link")
  appleFavicon.rel = "apple-touch-icon"
  appleFavicon.href = "https://i.postimg.cc/JzqssLBT/logo.jpg"
...
let currentLogoUrl = "https://i.postimg.cc/JzqssLBT/logo.jpg"
...
function resetLogoToDefault() {
  if (confirm("¿Estás seguro de que quieres restaurar el logo predeterminado?")) {
    currentLogoUrl = "https://i.postimg.cc/JzqssLBT/logo.jpg"
