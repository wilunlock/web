...
function checkLoginStatus() {
  const loggedInUser = localStorage.getItem("wilunlock-logged-user")
  if (loggedInUser) {
...
function clearToolForm() {
  ...
  document.getElementById("currentToolPreview").src = "/placeholder.svg?height=80&width=80"
...
// Complete the renderNotices function that was cut off
function renderNotices() {
  ...
  // Also render in admin if we're in admin panel
  renderNoticesAdmin()
}
